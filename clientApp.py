...
from ai_prediction.predictApp import PredictApi
from ai_training.trainApp import TrainApi
from ai_utils.utils import createDirectoryForUser, extractDataFromTrainingIntoDictionary, \
